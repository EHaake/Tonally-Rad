...
def constrain_pixels(points, intensity_threshold=20):
    ...
    # collect the lightness values of the selected pixels
    x_pts = points[:, 0]
    y_pts = points[:, 1]
    luminance_vals = l_chan[y_pts, x_pts]

    # find the mean of the lightness values
    luminance_mean = np.mean(luminance_vals)
...
if __name__ == '__main__':
    ...
    # convert image to LAB space and split into its channels
